...
void idt_inicializar() {
   ...
   IDT_ENTRY(32);
   IDT_ENTRY(33);
    idt[102].offset_0_15 = (uint16_t) ((uint32_t)(&_isr66) & (uint32_t) 0xFFFF);
    idt[102].segsel = (uint16_t) GDT_OFF_CODIGO_0;           
    idt[102].attr = (uint16_t) 0XEE00;
    idt[102].offset_16_31 = (uint16_t) ((uint32_t)(&_isr66) >> 16 & (uint32_t) 0xFFFF);
  }
